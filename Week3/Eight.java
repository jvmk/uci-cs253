 ...
 * function if it was to return a value. Note that this style result in some extremely ugly types for the parameters as
 * we're nesting {@link BiConsumer}s in {@link BiConsumer}s.
 *
...
public class Eight {
     ...
     *                     of the file.
     */
    public static void readFile(String filepath, BiConsumer<String, BiConsumer<String, BiConsumer<String, BiConsumer<List<String>, BiConsumer<List<String>, BiConsumer<Map<String, Integer>, BiConsumer<List<Pair<String, Integer>>, Consumer<Void>>>>>>>> nextFunction) {
        ...
        try(Stream<String> lines = Files.lines(Paths.get(filepath))) {
            ...
            nextFunction.accept(lines.collect(Collectors.joining(System.lineSeparator())), Eight::normalize);
     ...
     *                     resulting string.
     */
    public static void filterChars(String data, BiConsumer<String, BiConsumer<String, BiConsumer<List<String>, BiConsumer<List<String>, BiConsumer<Map<String, Integer>, BiConsumer<List<Pair<String, Integer>>, Consumer<Void>>>>>>> nextFunction) {
        ...
        nextFunction.accept(alphanumeric, Eight::scan);
    }
     ...
     *                     resulting string.
     */
    public static void normalize(String data, BiConsumer<String, BiConsumer<List<String>, BiConsumer<List<String>, BiConsumer<Map<String, Integer>, BiConsumer<List<Pair<String, Integer>>, Consumer<Void>>>>>> nextFunction) {
        nextFunction.accept(data.toLowerCase(), Eight::removeStopWords);
    }
     ...
     */
    public static void scan(String data, BiConsumer<List<String>, BiConsumer<List<String>, BiConsumer<Map<String, Integer>, BiConsumer<List<Pair<String, Integer>>, Consumer<Void>>>>> nextFunction) {
        // Separate into separate words by splitting for each whitespace.
        List<String> words = Arrays.asList(data.split("\\s+"));
        nextFunction.accept(words, Eight::frequencies);
    }
     ...
     *                     resulting list of words.
     */
    public static void removeStopWords(List<String> words, BiConsumer<List<String>, BiConsumer<Map<String, Integer>, BiConsumer<List<Pair<String, Integer>>, Consumer<Void>>>> nextFunction) {
        ...
        try(Stream<String> swStream = Files.lines(Paths.get("../stop_words.txt"))) {
            ...
            nextFunction.accept(words, Eight::sort);
        } catch (IOException ioe) {
            // Hide the fact that method is throwing a checked exception by rethrowing it wrapped in an unchecked
            // exception in order to allow this method to be referred to using method references.
            throw new RuntimeException(ioe);
     ...
     */
    public static void frequencies(List<String> words, BiConsumer<Map<String, Integer>, BiConsumer<List<Pair<String, Integer>>, Consumer<Void>>> nextFunction) {
        final Map<String, Integer> wordFreqs = new HashMap<>();
        words.forEach(word -> wordFreqs.merge(word, 1, (oldVal, newVal) -> oldVal + newVal));
        nextFunction.accept(wordFreqs, Eight::printText);
    }
     ...
     */
    public static void sort(Map<String, Integer> wordFreqs, BiConsumer<List<Pair<String, Integer>>, Consumer<Void>> nextFunction) {
